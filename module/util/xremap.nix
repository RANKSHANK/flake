...
lib.mkModule "xremap" [ "desktop" ] {
    ...
    services.xremap = {
        ...
        config = {
            ...
            modmap = let
                inherit (lib) flatten mapAttrsToList zipListsWith;
                ...
                qwerty-esdf = [
                    ...
                    "Q" "E" "W" "R" "T" "Y" "U" "I" "O" "P"
                    # Home row
                    "F" "A" "S" "D" "G" "H" "J" "K" "L" "SEMICOLON"
                    # Bottom row
                    "Z" "X" "C" "V" "B" "N" "M"
                ];
                colemak = [
                    # Top row
                    "Q" "W" "F" "P" "G" "J" "L" "U" "Y" "SEMICOLON"
                    # Home row
                    "A" "R" "S" "T" "D" "H" "N" "E" "I" "O"
                    # Bottom row
                    "Z" "X" "C" "V" "B" "K" "M"
                ];
                convertLayout = from: to: zipListsWith (og: new: lib.ternary (og == new) {} {
                    "KEY_${og}" = "KEY_${new}";
                }) from to; 
